                            ...
                            return (
                               <div key={i} className="flex items-center justify-between bg-white p-4 rounded-2xl border border-stone-200 shadow-sm gap-3">
                                  ...
                                  {existingInDict ? (
                                     ...
                                     <button onClick={()=>handleAnalyzeWord(w)} disabled={alreadyInTabs || loadingWord === cleanWWord} className="w-10 h-10 flex shrink-0 items-center justify-center bg-purple-50 text-purple-600 rounded-full active:scale-90 disabled:opacity-50">
                                        {loadingWord === cleanWWord ? <Loader2 className="w-5 h-5 animate-spin"/> : alreadyInTabs ? <Check className="w-5 h-5"/> : <Plus className="w-5 h-5"/>}
                                     </button>
                                  )}
                               </div>
                            )
